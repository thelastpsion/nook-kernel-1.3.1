...
//TODO:On Avocet at times framework is holding the device and never releases it.
//This will hold up the device from going to suspend. Need to enable this once 
			      ...
			      struct snd_pcm_hw_params *params)
{
	...
	err = codec_dai->ops.set_pll(codec_dai, WM8904_FLL_MCLK,
				CODEC_SYSCLK_FREQ, params_rate(params) * 256);
	if (err < 0)
		return err;

	err = snd_soc_dai_set_sysclk(codec_dai, WM8904_CLK_FLL,
