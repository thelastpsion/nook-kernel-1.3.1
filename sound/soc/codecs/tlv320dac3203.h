/*
 * linux/sound/soc/codecs/tlv320dac3203.h
 *
 *
...
#define AUDIO_NAME "dac3203"
#define DAC3203_VERSION "1.1"

#define TLV320DAC3203ID                  (0x18)
...
/* DAC3203 supported sample rate are 8k to 192k */
#define DAC3203_RATES	SNDRV_PCM_RATE_8000_192000

/* DAC3203 supports the word formats 16bits, 20bits, 24bits and 32 bits */
#define DAC3203_FORMATS	(SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S20_3LE \
			 | SNDRV_PCM_FMTBIT_S24_3LE | SNDRV_PCM_FMTBIT_S32_LE)

#define DAC3203_FREQ_12000000 12000000
#define DAC3203_FREQ_13000000 13000000
#define DAC3203_FREQ_24000000 24000000
...
#define DAC3203_WIDGET_NAME			0
/* control: mixer control name */
#define DAC3203_CONTROL_NAME		1
/* source: name of source name */
#define DAC3203_SOURCE_NAME			2

/* D15..D8 dac3203 register offset */
#define DAC3203_REG_OFFSET_INDEX    0
/* D7...D0 register data */
#define DAC3203_REG_DATA_INDEX      1
...
/* 8 bit mask value */
#define DAC3203_8BITS_MASK           0xFF
...
/* DAC3203 register space */
#define	DAC3203_CACHEREGNUM			256
...
#define REF_PWR_CTRL		(PAGE_1 + 123)
/****************************************************************************/
#define BIT7					(0x01 << 7)
...
/*
 *----------------------------------------------------------------------------
 * @struct  dac3203_setup_data |
 *          i2c specific data setup for DAC3203.
 ...
 *----------------------------------------------------------------------------
 * @struct  dac3203_priv |
 *          DAC3203 priviate data structure to set the system clock, mode and
 *          page number. 
 * @field   u32 | sysclk |
 *          system clock
 * @field   s32 | master |
 *          master/slave mode setting for DAC3203
 * @field   u8 | page_no |
 ...
 *          DAC3203 initialization data which has register offset and register 
 *          value.
 * @field   u16 | reg_offset |
 *          DAC3203 Register offsets required for initialization..
 * @field   u8 | reg_val |
 *          value to set the DAC3203 register to initialize the DAC3203.
 *----------------------------------------------------------------------------
 */
struct dac3203_configs {
	u8 reg_offset;
 ...
 * @field   u32 | blck_N |
 *          value for block N
 * @field   u32 | dac3203_configs |
 *          configurations for dac3203 register value
 *----------------------------------------------------------------------------
 */
struct dac3203_rate_divs {
	u32 mclk;
	...
	u8 madc;
	u8 blck_N;
	struct dac3203_configs codec_specific_regs[NO_FEATURE_REGS];
};
 ...
 *----------------------------------------------------------------------------
 */
extern struct snd_soc_dai tlv320dac3203_dai;
 ...
 *
 */
extern struct snd_soc_codec_device soc_codec_dev_dac3203;

#endif				/* _TLV320DAC3203_H */
